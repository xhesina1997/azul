(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('filepond'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define('ngx-filepond', ['exports', '@angular/core', 'filepond', '@angular/common'], factory) :
	(factory((global['ngx-filepond'] = {}),global.ng.core,global.filepond,global.ng.common));
}(this, (function (exports,core,filepond,common) { 'use strict';
...
var FilePondComponent = /** @class */ (function () {
    function FilePondComponent(root, zone) {
        ...
        outputs.forEach(function (output) {
            _this[output] = new core.EventEmitter();
        });
    }
    FilePondComponent.prototype.ngAfterViewInit = function () {
        ...
        this.zone.runOutsideAngular(function () {
            _this.pond = filepond.create(input, Object.assign({}, _this.options, { files: _this.files }));
        });
...
exports.registerPlugin = filepond.registerPlugin;
exports.FilePondModule = FilePondModule;
exports.ɵa = FilePondComponent;
